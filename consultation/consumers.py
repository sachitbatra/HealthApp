...
from authentication.models import UserSessionToken, DoctorSessionToken, AppUser
...
class ChatConsumer(AsyncConsumer):
    async def websocket_connect(self, event):
        ...
        self.curUser.__class__ = AppUser
        print(self.curUser)
    ...
    def get_user(self, session_token):
        ...
        if sessionDB is None:
            sessionDB = DoctorSessionToken.objects.filter(session_token=session_token).first()
